        ...
        <div class="button-list-flex">
            ...
            <a href="{{ route('internship.create') }}">
                <button class="btn btn-primary" href>
                    <i class="fa fa-plus" aria-hidden="true"></i> Create New Internship
                </button>
            </a>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <img class="img-thumbnail image-height"
                            src="{{ asset('assets/uploads/internship/'.$value->image)}}">
                    </td>
                    <td>{{$value->title}}</td>
                    ...
                    <td>
                        ...
                        <form method="POST" action="{{ route('internship.destroy' ,  [$value->id]) }}"
