        ...
        <div class="button-list-flex">
            ...
            <a href="{{ route('expertise.create') }}">
                <button class="btn btn-primary" href>
                    <i class="fa fa-plus" aria-hidden="true"></i> Create New Expertise
                </button>
            </a>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <img class="img-thumbnail image-height"
                            src="{{ asset('assets/uploads/expertise/'.$expertise->image)}}">
                    </td>
                    ...
                    <td>
                        ...
                        <form method="POST" action="{{ route('expertise.destroy' ,  [$expertise->id]) }}"
